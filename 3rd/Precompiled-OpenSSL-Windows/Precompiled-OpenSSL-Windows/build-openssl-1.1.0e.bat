...
SET PROJECT_VERSION=1.1.0e

:: SET PROJECT_SRC_DIR=D:\opensource\!BUILD_PROJECT!-!PROJECT_VERSION!
SET PROJECT_SRC_DIR=D:\opensource\!BUILD_PROJECT!-!PROJECT_VERSION!
SET PROJECT_BUILD_DIR=D:\opensource\!BUILD_PROJECT!-build-!PROJECT_VERSION!-vs!VS_VERSION!
SET PROJECT_INSTALL_DIR=D:\opensource\!BUILD_PROJECT!-dist-!PROJECT_VERSION!-vs!VS_VERSION!
